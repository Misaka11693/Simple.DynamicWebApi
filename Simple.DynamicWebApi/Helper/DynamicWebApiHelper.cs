...
internal static class DynamicWebApiHelper
{
    ...
    /// </summary>
    internal static string? SelectHttpMethod(string actionName, Dictionary<string, string[]> conventionalPrefixes)
    {
    ...
    /// </summary>
    internal static string RemoveHttpMethodPrefix(this string actionName, string httpMethod, Dictionary<string, string[]> conventionalPrefixes)
    {
        ...
        conventionalPrefixes.TryGetValue(httpMethod, out var prefixes);
        if (prefixes.IsNullOrEmpty())
        {
            return actionName;
        }
